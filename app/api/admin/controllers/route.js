...
function parseControllerBody(body) {
    return {
        ...
        metaTitleDe: body.metaTitleDe?.trim() || null,
        metaTitleEn: body.metaTitleEn?.trim() || null,
        metaDescriptionDe: body.metaDescriptionDe?.trim() || null,
        metaDescriptionEn: body.metaDescriptionEn?.trim() || null,
...
export async function POST(request) {
    try {
        ...
        const slug = await generateUniqueControllerSlug(body.interfaceName);
        if (!slug) {
        ...
        const controllerData = { ...parseControllerBody(body), slug, isActive: !!hasImages };
