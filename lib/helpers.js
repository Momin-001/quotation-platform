...
/**
 * Line net after discount on gross (qty × unit). VAT is applied once per offer on the server/PDF via {@link calculateOfferTotalWithQuotationTax}.
 */
...
/**
 * Sum line nets, then apply a single quotation VAT % to that sum (per Hauptangebot / Alternativangebot).
 */
...
/**
 * Build priced lines for one offer tree (main + additional + optional).
 */
