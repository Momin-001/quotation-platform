...
const DISPLAY_DETAIL_SPECS = [
    ...
    },
    {
        ...
        getValue: (p) =>
            p?.cabinetWidth && p?.cabinetHeight
    ...
    },
    {
        label: "Auflösung",
        getValue: (p) =>
            p?.cabinetResolutionHorizontal && p?.cabinetResolutionVertical
    ...
    },
    {
        ...
        getValue: (p) =>
            p?.powerConsumptionMax ? `${p.powerConsumptionMax} Watt` : null,
    },
    {
        label: "Gesamt Gewicht",
        getValue: (p) =>
            p?.weightWithoutPackaging
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .displaydetails-table td { padding: 6px 8px; border-bottom: 1px solid #ccc; vertical-align: top; }
