  ...
  },
  {
    ...
    getValue: (p) => {
      if (p?.isCustom) {
        ...
        return typ != null ? `${typ} Watt` : null;
      }
      return p?.powerConsumptionTypical
        ? `${p.powerConsumptionTypical} Watt`
        : null;
    },
  },
  {
    ...
    getValue: (p) => {
      if (p?.isCustom) {
        ...
        return max != null ? `${max} Watt` : null;
      }
      return p?.powerConsumptionMax ? `${p.powerConsumptionMax} Watt` : null;
    },
  },
  {
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .displaydetails-title { text-decoration: underline; margin-bottom: 8px; margin-top: 12px; }
    .displaydetails-table { width: 100%; border-collapse: collapse; margin-bottom: 16px; }
    .displaydetails-table td { padding: 6px 8px; border-bottom: none; vertical-align: top; }
    .displaydetails-col-label { width: 38%; text-align: left; }
    .displaydetails-col-value { width: 31%; text-align: left; }
    .displaydetails-table tbody tr:first-child td { border-bottom: 2px solid #000; }
...
<img src="${logoWithNameSrc}" style="height:40px;" />
</div>
...
const PDF_HEADER_TEMPLATE = `
  <div style="width: 100%; text-align: right; padding-right: 15mm;">
