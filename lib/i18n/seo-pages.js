...
export const SEO_PAGES = {
    "": {
        de: {
            title: "LED Display Anbieter Europa | B2B Marktplatz | ProLEDALL",
            description:
                "Europas B2B-Marktplatz für geprüfte LED-Videowände: Anbieter vergleichen, transparente Angebote erhalten und LED-Projekte skalieren. Kostenlos & unverbindlich.",
        },
        en: {
    ...
    "/products": {
        de: {
            title: "LED Videowand kaufen & vergleichen | ProLEDALL",
            description:
                "LED Videowände und Displays kaufen: Indoor, Outdoor, Fine Pitch & Mobile. Technische Daten im 1:1-Vergleich — von geprüften Herstellern. Jetzt Produkt anfragen.",
        },
        en: {
    ...
    "/leditor": {
        de: {
            title: "LED Wand Konfigurator | Angebot in 5 Min. | ProLEDALL",
            description:
                "LED-Videowand online konfigurieren: Abmessungen, Montage, IP-Schutz und Controller wählen — mehrere Herstellerangebote in 48 Stunden. Kostenlos starten.",
        },
        en: {
    ...
    "/become-partner": {
        de: {
            title: "LED Display Partner werden | Integratoren & Händler | ProLEDALL",
            description:
                "LED-Display-Projekte gemeinsam skalieren: Qualifizierte Anfragen, technischer Support, Demosysteme und exklusiver Projektschutz für Integratoren und Händler in Europa.",
        },
        en: {
    ...
    "/controllers": {
        de: {
            title: "LED Display Controller | Colorlight, Novastar, Brompton, LINSN",
            description:
                "Vergleichen Sie professionelle LED-Controller-Systeme wie Colorlight, Novastar, Brompton und LINSN. Vollständige Spezifikationen und Kompatibilitätsdaten für LED-Videowandprojekte.",
            robots: { index: false },
        },
        en: {
